...
#define F0 (1.0 / 4294967296.0)

uvec3 hash(uint n) {
  n = (n << 13u) ^ n;
  n = n * (n * n * 15731u + 789221u) + 1376312589u;
  uvec3 k = n * uvec3(1u, 511u, 262143u);
  return uvec3(n) * uvec3(1u, 511u, 262143u);
}

uint coord3(vec3 p) {
  uvec3 q = uvec3(ivec3(p) + 1000);
  return q.x + q.y * 2111u + q.z * 2111u * 2111u;
}
