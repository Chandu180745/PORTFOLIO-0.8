...
class Media {
  ...
  constructor({
    geometry, gl, image, index, length, renderer, scene, screen, text, viewport, bend, textColor, borderRadius = 0, font, imageScale = 1
  }: MediaProps) {
...
class App {
  ...
  constructor(container: HTMLElement, { items, bend = 1, textColor = '#ffffff', borderRadius = 0, font = 'bold 30px DM Sans', scrollSpeed = 2, scrollEase = 0.05, imageScale = 1 }: AppConfig) {
  ...
  createMedias(items: { image: string; text: string }[] | undefined, bend: number = 1, textColor: string, borderRadius: number, font: string) {
    ...
    this.medias = this.mediasImages.map((data, index) => {
      return new Media({
        ...
        bend, textColor, borderRadius, font, imageScale: this.imageScale
      });
    });
  }
...
export default function CircularGallery({
  items, bend = 3, textColor = '#ffffff', borderRadius = 0.05, font = 'bold 30px DM Sans', scrollSpeed = 2, scrollEase = 0.05, imageScale = 1
